...
function createPeerConnection() {
  var defaultConfiguration = {
    ...
    iceServers: [
      {
        urls: [
          "turn:172.20.10.4:3478?transport=udp",
          "turn:172.20.10.4:3478?transport=tcp", // 可以插入多个进行备选
        ],
        username: "ydy",
        credential: "123456",
      },
      {
        urls: ["stun:172.20.10.4:3478"],
      },
    ],
  };
...
fishRTCEngine = new FishRTCEngine("ws://172.20.10.4:8099");
